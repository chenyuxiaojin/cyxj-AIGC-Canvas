...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            agent_bridge::desktop_canvas_commands,
            agent_bridge::desktop_submit_canvas_command,
            agent_bridge::desktop_claim_canvas_command,
            agent_bridge::desktop_finish_canvas_command,
            agent_bridge::desktop_approve_canvas_command,
            agent_bridge::desktop_canvas_generation_permission,
            agent_bridge::desktop_get_canvas_command,
            agent_bridge::desktop_read_canvas_transfer,
            agent_bridge::desktop_write_canvas_transfer,
